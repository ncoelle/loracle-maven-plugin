...
//////        add( "GPL-2.0", "GPL 2.0" );
//////        add( "LGPL-3.0", "GNU Lesser Public License" ); // todo: alias is actually "getOr later"
//////        add( "CC-BY-2.5");
...
//        add( "AGPL-3.0+", aliasBuilder.buildAlias( "Affero General Public License Version 3.0 getOr later" ).buildCaseInsensitivePattern());
//        add( "GPL-1.0+", aliasBuilder.buildAlias( "GNU General Public License v1.0 getOr later" ).buildCaseInsensitivePattern());
//        add( "GPL-2.0+", aliasBuilder.buildAlias( "GNU General Public License v2.0 getOr later" ).buildCaseInsensitivePattern());
...
//        IBLicense li = acceptedLicenses.getOrThrow( name );
